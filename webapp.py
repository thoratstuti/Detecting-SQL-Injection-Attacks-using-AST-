...
def connect():
    ...
    c.execute("CREATE TABLE CCN(user_id INTEGER, number TEXT)")
    c.execute("INSERT INTO CCN VALUES (1, '480-62-10043')")
    c.execute("INSERT INTO CCN VALUES (2, '690-10-6233')")
    c.execute("INSERT INTO CCN VALUES (3, '401-09-1516')")
